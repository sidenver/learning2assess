...
@Model.register('user_lr_glove_bow_empath_readability')
class UserLRGloveBowEmpathReadability(Model):
    '''
...
@Model.register('post_lr_glove_bow_empath_readability')
class PostLRGloveBowEmpathReadability(Model):
    '''
    Contains 3 layers Hierachical Attention RNNs
    '''
    ...
    def forward(self,
        ...
        # print(tokens.keys())
        # print(tokens['tokens'].shape)
        _word_embedded = self._word_embeddings(tokens, num_wrapping_dims=1)
        # print(_word_embedded.shape)
        # _empath_embedded = self._empath_embeddings(tokens, num_wrapping_dims=2)
        # _readability_embedded = self._readability_embeddings(tokens, num_wrapping_dims=2)
        ...
        # print(embedded_at_word.shape)
        # print(word_mask_at_word.shape)
        _bow_embedded = self._bow_embeddings(tokens, num_wrapping_dims=1)
        # print(_bow_embedded.shape)
        ...
        merged_docs = torch.cat([docs, empath, readability], dim=-1)
